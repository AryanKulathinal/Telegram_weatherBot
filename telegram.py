...
TOKEN = "Paste-your-telegram-bot-api-key-here"
OWM_KEY = "Paste-your-OpenWeather-api-key-here"
...
cities = ["Thiruvananthapuram","Cochin","Bengaluru","Delhi","Pune"]
...
def getWeather(place):
    if isinstance(place, dict):  # coordinates provided
        lat, lon = place.get("latitude", 0), place.get("longitude", 0)
